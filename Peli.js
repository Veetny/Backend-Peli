...
db.serialize(() => {
  ...
  // Lisätään pääkaupunki kysymyksiä ja vastauksia tietokantaan
  db.run('INSERT INTO questions (question) VALUES ("Mikä on Suomen pääkaupunki")');
  db.run('INSERT INTO answers (question_id, answer) VALUES (1, "Helsinki")');

  db.run('INSERT INTO questions (question) VALUES ("Mikä on Venäjän pääkaupunki")');
  db.run('INSERT INTO answers (question_id, answer) VALUES (2, "Moskova")');

  db.run('INSERT INTO questions (question) VALUES ("Mikä on Intian")');
  db.run('INSERT INTO answers (question_id, answer) VALUES (3, "New Delhi")');

  db.run('INSERT INTO questions (question) VALUES ("Mikä on Ukrainan pääkaupunki")');
  db.run('INSERT INTO answers (question_id, answer) VALUES (4, "Kyiv")');

  db.run('INSERT INTO questions (question) VALUES ("Mikä on Yhdysvaltojen pääkaupunki")');
  db.run('INSERT INTO answers (question_id, answer) VALUES (5, "Washington DC")');
});
